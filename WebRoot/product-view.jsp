...
<body>
	...
	<div id="main" class="wrap">
		...
		<div id="product" class="main">
			...
			<div class="infos">
				<div class="thumb">
					<img src="<s:property value="product.proPic"/>" />
				</div>
				<div class="buy">
					<p>
						商城价：<span class="price">￥<s:property value="product.price"/></span>
					</p>
					<p>库 存：<s:property value="product.stock"/></p>
					<p>库 存：有货</p>
					<p>库 存：有货</p>
					<p>库 存：有货</p>
					<div class="button">
						<input type="button" name="button" value=""
							onclick="goBuy(<s:property value='product.id'/>)" /><a href="#">放入购物车</a>
					</div>
				</div>
				<div class="clear"></div>
			</div>
